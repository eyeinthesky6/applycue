...
Instead, please email **hi@eyeinthesky6.io** with:
...
- **Dashboard** (`dashboard-server.mjs`) — local HTTP, path traversal, or unsafe write vulnerabilities
...
- ApplyCue is a local tool — there is no hosted service to attack
