...
The generated plan also includes a reviewable `searchProfile`. This is ApplyCue's equivalent of Career OS-style title, location, and content filters, but generated from the user's profile instead of a fixed `portals.yml`.
