# ApplyCue -- Danske modes (`modes/da/`)

Denne mappe indeholder de danske oversættelser af de vigtigste ApplyCue-modes for kandidater, der søger på det danske marked.
