# Geteilter Kontext -- ApplyCue (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle ApplyCue-Modi
     in der deutschen Variante. Bevor du ApplyCue verwendest, MUSST du:
