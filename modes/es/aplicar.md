...
5. **ApplyCue proof point**: incluir en "Información adicional" si existe ese campo
...
3. Sugerir el siguiente paso: `/applycue contacto` para LinkedIn outreach hacia el hiring manager
