...
5. **ApplyCue proof point:** includerlo nel campo "Informazioni aggiuntive" se presente nel modulo.
...
3. Suggerire il passo successivo: `/applycue contacto` per avviare il contatto su LinkedIn con il responsabile della selezione.
