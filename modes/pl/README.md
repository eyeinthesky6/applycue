# ApplyCue -- Tryby polskie (`modes/pl/`)

Ten folder zawiera polskie tłumaczenia głównych trybów ApplyCue dla kandydatów celujących w polski rynek pracy (Polska oraz polskojęzyczne zespoły).
