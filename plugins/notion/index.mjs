...
//
// Setup: a "ApplyCue" parent page in Notion containing an "Applications" DB
...
async function applicationsDb(client) {
  ...
  if (!apps) throw new Error('No "Applications" database found under the ApplyCue page — create it and share the integration with it.');
  return apps;
}
