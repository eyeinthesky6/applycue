---
name: applycue-plugin-notion
description: How to mirror the ApplyCue tracker to a Notion database and read records back as job leads.
license: MIT
---
...
- `node plugins.mjs run notion export` — push each tracker row (company / role /
  status / score) to the "Applications" database under your ApplyCue page.
...
A "ApplyCue" parent page in Notion containing an "Applications" database with
