 ...
 * APPLYCUE_TRACKER / APPLYCUE_ADDITIONS env overrides and assert:
...
function runScript(script, args, sandbox) {
  const env = {
    ...process.env,
    APPLYCUE_TRACKER: sandbox.tracker,
    APPLYCUE_ADDITIONS: sandbox.additions,
    APPLYCUE_TRACKER_LOCK: sandbox.lock,
  };
  try {
